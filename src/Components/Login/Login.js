...
const Login = () => {
  ...
  const githubLoginButtonClicked = () => {
  ...
  return (
    <div>
      <div className="login-from-main flex justify-center items-center mt-20 px-4">
        <form className="lg:w-[20rem] text-left" onSubmit={loginFromSubmit}>
          ...
          <button
            type="submit"
            class="text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 lg:w-full"
          >
            Sign In
          </button>
          ...
          <div className="button-group mt-8">
            ...
            <button
              onClick={githubLoginButtonClicked}
              type="button"
